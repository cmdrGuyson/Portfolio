...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    const mailtoLink = `mailto:gayanga@midfunnel.com?subject=Message%20from%20${name}&body=${message}%0D%0A%0D%0AFrom:%20${name}%20(${email})`;
            ...
            <header>
              ...
              <div className="my-8">
                <h4 className="mb-4 text-sm font-semibold text-gray-50">
                  Schedule a call or reach out to me at{" "}
                  <a href="mailto:gayanga@midfunnel.com" className="underline">
                    gayanga@midfunnel.com
                  </a>
                </h4>
                <iframe
