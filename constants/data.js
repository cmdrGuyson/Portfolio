const data = {
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "A centralized audio controller web application designed for Mercedes Benz vehicle dealerships which can connect to the devices located in each audio zone of the premises which will redirect the audio to the speaker installed. The application can individually change playlists, songs, and volume of the music played in each of the showroom areas in real time. Different playlists can be played to match the event, crowd or area via this application at different audio zones since the application can handle multiple devices.",
      link: "https://github.com/cmdrGuyson/MercedesMusic-server",
      imgUrl: "/music.png",
      stack: ["React", "NodeJS", "Firebase", "FCM"],
    },
    {
      title: "ExoticPlunder",
      description:
        "As a self identified weeb, I love manga and anime. With that comes the attraction towards the exotic side of manga as well. Since doujins don't have a good reader for iOS devices, I made my own.",
      link: "#",
      imgUrl: "/exotic-plunder.png",
      stack: ["ReactNative", "Firebase"],
    },
    {
      title: "Aether",
      description:
        "'Aether' is a discord bot that will give you updated details on emergency situations happening around the world such as the recent covid-19 outbreak.",
      link: "https://github.com/cmdrGuyson/Aether",
      imgUrl: "/aether.png",
      stack: ["DiscordJS", "JavaScript"],
    },
    {
      title: "Mingle",
      description:
        "In-house social media platform for universities. This web-application consisted of many features like posts, groups, managing friends",
      link: "https://github.com/cmdrGuyson/Mingle",
      imgUrl: "/mingle.png",
      stack: ["Java", "Servlets-MVC"],
    },
    {
      title: "Textual",
      description:
        "Multi-tabbed text editor application supporting rich text, auto-saving, spell-checking as well as for your super secret needs, advanced AES-256 encryption functionalities",
      link: "https://github.com/cmdrGuyson/Textual",
      imgUrl: "/book.png",
      stack: ["C#", ".NET"],
    },
    {
      title: "ChatShell",
      description:
        "'ChatShell' is an anonymous client-server chat application featuring message encryption. Facilitates private chats as well as private chats",
      link: "https://github.com/cmdrGuyson/ChatShell",
      imgUrl: "/shell.png",
      stack: ["C#", ".NET"],
    },
  ],
  ...
  socialLinks: {
    ...
    github: "https://github.com/cmdrGuyson",
  },
};
